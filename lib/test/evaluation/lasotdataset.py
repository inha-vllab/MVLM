...
class LaSOTDataset(BaseDataset):
    ...
    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.lasot_dir
    ...
    def _construct_sequence(self, sequence_name):
        ...
        occlusion_label_path = os.path.join(self.base_path, class_name, sequence_name, 'full_occlusion.txt')

        # Load language query from nlp.txt
        ...
        out_of_view_label_path = os.path.join(self.base_path, class_name, sequence_name, 'out_of_view.txt')
        ...
        frames_list = [os.path.join(frames_path, '{:08d}.jpg'.format(frame_number)) for frame_number in range(1, ground_truth_rect.shape[0] + 1)]
