...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None):
    ...
    settings.cfg_file = os.path.join(prj_dir, 'experiments', script_name, config_name + '.yaml')
...
def main():
    ...
    # torchrun passes LOCAL_RANK via environment variable instead of --local_rank argument
